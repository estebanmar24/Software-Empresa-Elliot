...
export default function DashboardScreen({ navigation }) {
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            {/* Top Navigation */}
            {/* Top Navigation */}
            <CustomNavBar navigation={navigation} activeRoute="Tablero Semáforos" />
                ...
                {periodosDisponibles.length > 0 ? (
                    <>
                        ...
                        <select
                            ...
                            style={{ ...styles.select, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}
                        >
                        ...
                        <select
                            ...
                            style={{ ...styles.selectLarge, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}
                        >
                            ...
                            {(getMesesParaAnio(anio).length > 0 ? getMesesParaAnio(anio) :
                                ...
                                <option key={p.mes} value={p.mes}>{getMesNombre(p.mes)}</option>
                            ))}
                        </select>
                    </>
                ) : (
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <select value={anio} onChange={(e) => setAnio(parseInt(e.target.value))} style={{ ...styles.select, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}>
                            {[2024, 2025, 2026].map(a => <option key={a} value={a}>{a}</option>)}
                        </select>
                        <Text style={[styles.label, { marginLeft: 15, marginRight: 5, color: colors.text }]}>Mes:</Text>
                        <select value={mes} onChange={(e) => setMes(parseInt(e.target.value))} style={{ ...styles.selectLarge, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}>
            ...
            <View style={[styles.reportSection, { backgroundColor: colors.card, shadowColor: '#ccc' }]}>
                ...
                <View style={styles.reportControls}>
                    <View style={styles.controlGroup}>
                        ...
                        <select value={reportType} onChange={(e) => setReportType(e.target.value)} style={{ ...styles.selectLarge, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}>
                    ...
                    <View style={styles.controlGroup}>
                        ...
                        <select value={reportPeriod} onChange={(e) => setReportPeriod(e.target.value)} style={{ ...styles.selectLarge, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}>
                    ...
                    {reportPeriod === 'semanal' && (
                        <View style={styles.controlGroup}>
                            ...
                            <select value={semana} onChange={(e) => setSemana(parseInt(e.target.value))} style={{ ...styles.selectLarge, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}>
                    ...
                    {reportType === 'operario' && (
                        <View style={styles.controlGroup}>
                            ...
                            <select value={selectedOperario} onChange={(e) => setSelectedOperario(e.target.value)} style={{ ...styles.selectLarge, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}>
                                <option value="">-- Seleccione Operario --</option>
                                <option value="todos">TODOS (Reporte Detallado)</option>
                                {filteredUsuarios.length > 0 ? (
                                    filteredUsuarios.map(u => (
                                        <option key={u.id} value={u.id}>{u.nombre}</option>
                                    ))
                                ) : (
                                    <option disabled>No hay operarios con datos</option>
                                )}
                            </select>
                        </View>
                    )}
                    ...
                    {reportType === 'maquina' && (
                        <View style={styles.controlGroup}>
                            ...
                            <select value={selectedMaquina} onChange={(e) => setSelectedMaquina(e.target.value)} style={{ ...styles.selectLarge, backgroundColor: colors.inputBackground, color: colors.text, borderColor: colors.border }}>
                                <option value="">-- Seleccione Maquina --</option>
                                <option value="todos">TODAS (Reporte Detallado)</option>
                                {filteredMaquinas.length > 0 ? (
                                    filteredMaquinas.map(m => (
                                        <option key={m.id} value={m.id}>{m.nombre}</option>
                                    ))
                                ) : (
                                    <option disabled>No hay máquinas con datos</option>
                                )}
                            </select>
                        </View>
                    )}
